...
public class PaypalController {
    ...
    public static final String successUrl = "http://localhost:8099/pay/success";
    public static final String cancelUrl = "http://localhost:8099/pay/cancel";
